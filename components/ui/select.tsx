...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-full items-center justify-between gap-2 rounded-lg border px-3 text-sm whitespace-nowrap transition-all duration-150 outline-none select-none",
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          "relative z-50 max-h-72 min-w-[8rem] overflow-hidden rounded-lg shadow-xl border border-[var(--border-strong)]",
    ...
    >
      <span className="pointer-events-none absolute right-2 flex size-4 items-center justify-center">
        <SelectPrimitive.ItemIndicator>
          <CheckIcon className="pointer-events-none size-4 text-[var(--accent)]" />
        </SelectPrimitive.ItemIndicator>
      </span>
