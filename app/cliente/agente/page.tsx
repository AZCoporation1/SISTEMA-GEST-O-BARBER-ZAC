  ...
  return (
    <div className="flex flex-col h-full justify-center items-center text-center space-y-6 animate-in fade-in duration-500 pb-12">
      ...
      <div className="relative w-24 h-24 flex items-center justify-center">
        ...
        <div className="relative w-16 h-16 bg-card rounded-2xl border border-border flex items-center justify-center shadow-lg overflow-hidden">
      ...
      <div className="pt-8">
        <Link 
          ...
          className="inline-flex items-center justify-center gap-2 h-11 px-6 rounded-full bg-primary text-primary-foreground font-medium hover:bg-primary/90 transition-colors"
        >
